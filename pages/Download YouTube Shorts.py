...
# Title of the app
st.html('<h1 style="text-align:center;color:#ff0000;">Youtube ▶ Shorts Downloader</h1>')

# Input: YouTube video URL
video_url = st.text_input("Enter the YouTube short URL:", placeholder='https://www.youtube.com/shorts/dDVFnfCwjHA')
allres = []

if video_url:
    try:
        # Fetch YouTube video object
        yt = YouTube(video_url, on_progress_callback=on_progress,use_po_token= True, token_file='tokens.json')
        ...
        with col2:
            ...
            if st.button("Get Short"):
                with st.spinner("Preparing short..."):
                    ...
                    st.toast("short downloaded successfully!")
